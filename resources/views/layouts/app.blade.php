    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-primary/80 backdrop-blur-md border-b border-white/10 shadow-lg">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex md:items-center">
                    ...
                    @endguest {{-- This @endguest closes the initial @guest / @else --}}
                </div>
            </div>
        </div>
        ...
        <div class="hidden md:hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 bg-primary/90 backdrop-blur-md">
                {{-- These should probably be dynamic links to categories --}}
                ...
                @endguest {{-- This @endguest closes the initial @guest / @else for the mobile menu --}}
            </div>
        </div>
    </nav>

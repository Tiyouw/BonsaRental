...
<footer class="bg-dark text-white mt-auto">
    <div class="container mx-auto py-8 px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                <h5 class="text-lg mb-3">Kontak</h5>
                <ul class="space-y-2 text-sm">
                    <li>Jl. Kahuripan 1A DC-06, Sumbersari, Jember</li>
                    <li>Telp: 082132341102</li>
                    <li>Email: info@bonsarental.com</li>
                </ul>
                <div class="mt-4 flex space-x-4">
                    <a href="#" class="text-white hover:text-light">
        ...
        <div class="text-center">
            <p class="text-sm">&copy; {{ date('Y') }} BonsaRental. Punya Gua Anjay.</p>
        </div>
    </div>
</footer>
